      ...
      <div className="container">
        ...
        <form id="paymentForm" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="form-group">
            ...
            <input type="text" id="cardNumber" name="cardNumber" maxLength="16" required value={cardNumber} onChange={(e) => setCardNumber(e.target.value)} />
          </div>

          <div className="form-group">
            <label htmlFor="cvv">CVV:</label>
            <input type="text" id="cvv" name="cvv" maxLength="4" required value={cvv} onChange={(e) => setCvv(e.target.value)} />
          </div>

          <div className="button-group">
            <button type="button" className="green-button" onClick={encryptData}>Cifrar Datos</button>
            <button type="button" className="green-button" onClick={() => decryptCustomData(decryptedText)}>Desencriptar Datos</button>
          ...
          <div className="form-group" style={{ marginTop: '20px' }}>
            ...
            <input type="text" id="inputToDecrypt" placeholder="Ingrese texto cifrado" value={decryptedText} onChange={(e) => setDecryptedText(e.target.value)} />
            {decryptedText && (
...
export default TEAEncryption;

// Estilos (puedes añadir estos estilos a tu CSS)
<style>
  .container {
    max-width: 600px;
    margin: 0 auto;
