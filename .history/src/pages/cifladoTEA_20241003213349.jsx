    ...
    return (
        <div className="app-container">
            <div className="form-container text-black">
                <h2 className="">Formulario de Pago Seguro - TEA -</h2>
                <form onSubmit={e => e.preventDefault()}>
                    <div className="input-group">
                        ...
                        <input
                            ...
                            id="name"
                            name="name"
                            className="p-inputtext text-black"
                            required
                            value={name}
                    ...
                    <div className="result-container">
                        {encryptedName && (
                            <div className="resultado-container">
                                <h4 className="text-black">Nombre Cifrado:</h4>
                        ...
                        {encryptedCard && (
                            <div className="resultado-container">
                                <h4 className="text-black">Número de Tarjeta Cifrado:</h4>
                                <div className="resultado">
                        ...
                        {encryptedCVV && (
                            <div className="resultado-container">
                                <h4 className="text-black">CVV Cifrado:</h4>
                                <div className="resultado">
