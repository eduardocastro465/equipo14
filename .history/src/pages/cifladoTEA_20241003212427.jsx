...
import './TeaEncryptionApp.css'; // Asegúrate de importar el archivo CSS

const DELTA = 0x9e3779b9;
const NUM_ROUNDS = 32;
let globalKey = null;

const TeaEncryptionApp = () => {
      ...
      <div className="form-container">
        ...
        <form onSubmit={e => e.preventDefault()}>
          ...
          <div className="button-group">
            ...
            <button type="button" className="btn-cifrar" onClick={sendData} disabled={!encryptedName || !encryptedCard || !encryptedCVV}>
              Enviar Datos
            </button>
          </div>
