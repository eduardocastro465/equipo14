    ...
    const copyToClipboard = () => {
        if (cipherText) {
            navigator.clipboard.writeText(cipherText)
                .then(() => showToast("Texto cifrado copiado al portapapeles."))
                .catch(() => showToast("Error al copiar el texto."));
        } else {
            showToast("No hay texto cifrado para copiar.");
        }
    };
        ...
        <main className="app-container">
            ...
            <div className="form-container">
                ...
                <div className="text-section">
                    ...
                    <button className="action-button" onClick={copyToClipboard} disabled={!cipherText}>
                        Copiar Cifrado
                    </button>
